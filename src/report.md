...
<img src="./photos/Part_1/task_1/point_3/docker_run_b.png" alt="`docker run -d" width="400"/>
...
<img src="./photos/Part_1/task_1/point_4/docker_ps.png" alt="`docker ps" width="400"/>
...
<img src="./photos/Part_1/task_1/point_6/docker_stop_ps.png" alt="`docker ps" width="400"/>


##### Запусти докер с портами 80 и 443 в контейнере, замапленными на такие же порты на локальной машине, через команду *run*.

<img src="./photos/Part_1/task_1/point_7/docker_run_80_443.png" alt="`docker run" width="400"/>
...
<img src="./photos/Part_1/task_1/point_9/docker_restart.png" alt="`docker restart" width="400"/>

<img src="./photos/Part_1/task_1/point_9/docker_app.png" alt="`docker app" width="400"/>
...
<img src="./photos/Part_2/point_4/copy_nginx.png" alt="copy nginx to docker" width="400"/>
<img src="./photos/Part_2/point_4/check_copied_nginx.png" alt="check_copied_nginx" width="400"/>
...
<img src="./photos/Part_2/point_7/tar.png" alt="tar" width="400"/>


##### Останови контейнер.

<img src="./photos/Part_2/point_8/stop_container.png" alt="stop container" width="400"/>


##### Удали образ через `docker rmi [image_id|repository]`, не удаляя перед этим контейнеры.
`docker rmi -f nginx`

<img src="./photos/Part_2/point_9/rm_nginx.png" alt="rm ghinx" width="400"/>

##### Удали остановленный контейнер.

<img src="./photos/Part_2/point_10/rm_container.png" alt="rm container" width="400"/>
...
docker import <путь_к_архиву> <имя_нового_образа>:<тег>

<img src="./photos/Part_2/point_11/docker_import.png" alt="import container" width="400"/>

Docker создаёт новый образ на основе файлов из архива container.tar.
Новый образ не имеет истории слоёв (в отличие от образов, созданных через docker build).
Метаданные контейнера (например, команда запуска) не сохраняются. Если нужно указать команду по умолчанию, используй команду docker commit или создай Dockerfile.



##### Запусти импортированный контейнер.

<img src="./photos/Part_2/point_12/new_cont_start.png" alt="start new container" width="400"/>
